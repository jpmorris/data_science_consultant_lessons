...
- Agents
  - Go through an Agents course?
  - Agent CLI Poweruser -- maybe wait until they are actually using it
- "What makes a Great Data Scientist"
- Review of All Models - would be great to get ontologies first
- LLM from Scratch - Application
- Communication
- "What makes a Great Technical Practitioner"

Also:

- SWE and Advanced Python - Design Patterns
- SWE and Advanced Python - Data Structures
- SWE and Advanced Python - Algorithms

# Showcases

- sympy - symbolic plotting - hsa/hra plot
- Beta/Binomial - need to find this
- recipe manager - how does express and chrome plugins work
...
- Review of famous security vulnerabilities?
- Review METR tasks and explore solutions
- Review All the AI Benchmarks and maybe go through some of the problems

# Future git intermediate talk (recipes and common situations):

- "Accidentally committed to main but didn't push" - create branch, reset head
  back 1 in main, checkout branch, push
...
- which metrics are robust to class imbalance? Why is f1 score robust to class
  imbalance?
...
- Project learning requirements:
  ...
  - Programming
    ...
    - Algorithms
      ...
      - Sample of some LeetCode Design Patterns for Python for Scripting/Data
        Science
...
- Taylor as guest speaker for programming questions (need a GOOD list of
  programming questions, after projects and programming review
...
- Git
  - trunked based development vs gitflow (and how it relates to (our) data
    science repo)
- pythonic
...
The goal here is to get a good overview of a bunch of relevant programming
languages, take notes, and decide if there is important comparative points.

Since we are surveying many langauges, we need short dense courses.

C C++ C# Objective-C JavaScript TypeScript Java Kotlin Swift SQL Rust Scala R
Julia Haskell Ruby Perl PHP Lua Prolog Lisp Scheme Smalltalk Erlang Elixir
Clojure Groovy Fortran Groovy Cobol Ada Pascal
...
- If you dedicate 2.5 hours a week to this, you can get through it in about 50
  weeks. This is a year-long course if you take it slow.

## List of programming best-practices to cover -- Brainstorming for eventual content

- logging without polluting app code
- do not execute at import-time - keep your module-level globals clean of
  executable code
  - avoid execution code at global-level
  - sqlalchemy persistent engine vs singleton vs factory vs. creating a new
    engine every time
...
- OOP vs Functional Programming vs programming with functions
  ...
  - Should a data scientist ever do MyDataframe(pd.DataFrame) or anything like
    that? I there ever a time for a data scientist to use OOP?
- Do you pass in the most raw form of data to a function or do you pass in the
  most processed form of data to a function? E.g. you need to transform a
  np.array(list[dict]) do you past the list and transform in the function or do
  you transform before you pass into the function. Example: see spacy example
  labeled_spacy_files.py in dagster code
- how to rewrite function to support: 2 separate functions, function flag, two
  independent functions or modify data storage (see: labeled_spacy_files
  comparision with unlabeled)
...
- review of all stat tests also CONOVA etc, need good examples database review
  cleaning + transformation + selection review of pandas/numpy/scikit API data
  normalization, imputation, etc part of database review unstructured data data
  security awareness algorithm comparision automl feature selection review
  review of metrics math for data science algorithm comparision review of
  unsupervised learning review of NLP review of Deep Learning review of AWS
  services data pipelining Mlops model monitoring high-performance computing
  hadoop et al big data review (esp platforms agile review?
