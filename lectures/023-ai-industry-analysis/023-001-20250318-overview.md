...
| Gary Marcus       | Cognitive Scientist, Founder of two AI Companies | Will transform jobs; wont take massively replace jobs in the short term                                                 |                                                                                                                                                  |
...
For ongoing evaluation of vibecoding experience see
![Vibecoding Evaluation](./023-003-20250829-ongoing-vibcoding-eval.md)
...
- MCP - Model Conext Protocol
  ...
  - A standard for connecting AI assistants to the systems whwere the data lives ent "Attention is
    all you need"￼
