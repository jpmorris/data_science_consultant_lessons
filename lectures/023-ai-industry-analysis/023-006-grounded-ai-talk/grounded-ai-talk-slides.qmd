...
<!-- STAGE 2/3 (nexttoken-stage-2-cot): reasoning -- <reasoning>/<user summary>
     blocks generate on the raw-context pane; terminal shows "Thinking..."
     during reasoning, flashes the summary sentence whole, then streams the
     real answer word-by-word once ready -->
