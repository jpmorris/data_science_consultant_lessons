...
<!-- STAGE 8/9 (llm-stage-8-training): training: shared shaded LLM box (unique training-specific content TBD) -->
...
Diagram note: this stage currently shows the same shaded LLM box as
stage 5 (no training-specific content yet) -- forward pass, backward
pass, and weight updates aren't visually distinguished from stage 5's
sketch yet. Planned follow-up.
:::

<!-- STAGE 9/9 (llm-stage-9-inference): inference: shared shaded LLM box (unique inference-specific content TBD) -->
...
Diagram note: this stage currently shows the same shaded LLM box as
stage 5 (no inference-specific content yet) -- prompt tokens in, sampled
token out, and the KV cache aren't visually distinguished from stage 5's
sketch yet. Planned follow-up.
:::
