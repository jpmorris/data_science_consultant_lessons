...
added back to its output. "Skip" names the topology (the connection skips
over the block); "residual" names what the block has to learn — a correction
on top of the input, rather than the full transformation from scratch.
