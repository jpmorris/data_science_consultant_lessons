...
<div class="diagram-split-row">
  ...
  <div class="diagram-split-text">
    <ul>
      <li><strong>Zero-shot</strong>: ask a novel question, no examples — it just answers, one predicted token at a time</li>
    </ul>
  </div>
</div>
```
...
to the context, predict the next one, repeat. Zero-shot means no examples in
the prompt — just a system prompt, a question, and the model sampling its
way to a response one token at a time.
:::
...
<div class="diagram-split-row">
  ...
  <div class="diagram-split-text">
    <ul>
      <li>Zero-shot: ask a novel question, no examples — it just answers, one predicted token at a time</li>
      <li><strong>Chain-of-thought</strong>: ask it to "think step by step" — reasoning improves</li>
    </ul>
  </div>
</div>
```
...
<div class="diagram-split-row">
  ...
  <div class="diagram-split-text">
    <ul>
      <li>Zero-shot: ask a novel question, no examples — it just answers, one predicted token at a time</li>
      <li>Chain-of-thought: ask it to "think step by step" — reasoning improves</li>
