...
```{=html}
<div class="diagram-panel" style="height: auto; padding: 1.2em;">
...
| "GPT-5 solved 10 Erdős problems" (OpenAI)                 | Oct 2025           | **Lit search — retracted**                        | VP's claim on X; Thomas Bloom (erdosproblems.com) called it "a dramatic misrepresentation" — the solutions already existed in published literature           |
| Erdős Problem 333                                         | Dec 2025           | **Lit search — false claim**                      | Claimed as "first fully autonomous" LLM solve; Erdős himself had already solved it in a 1977 paper                                                          |
...
| Erdős unit-distance disproof (OpenAI)                     | May 2026           | **Harness** — contrary to its own framing         | The claim to double-check before citing as "the one non-harness win" — see notes                                                                             |
...
| "10 more advances," incl. 3 more Erdős (OpenAI "Astra")   | Aug 2026           | **Harness — unverified**                          | Announced only days before this deck was last updated; no independent verification yet, treat as unconfirmed                                                 |
:::
