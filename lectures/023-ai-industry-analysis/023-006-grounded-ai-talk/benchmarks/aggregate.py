...
DISPLAY_NAME_OVERRIDES = {
    ...
    "agentdojo": "AgentDojo",
    "agentharm": "AgentHarm",
    "air-bench-audio": "AIR-Bench (Audio Instruct)",
    "airs-bench": "AIRS-Bench",
    "alfworld-scienceworld": "ALFWorld / ScienceWorld / Habitat-BEHAVIOR / RoboCasa / EMMOE",
    "alpacaeval-2": "AlpacaEval 2.0",
    "apps-bench": "APPS",
    "appworld": "AppWorld (+ AppWorld-UL)",
    "assistantbench": "AssistantBench",
    "assistgui": "AssistGUI",
    "astabench": "AstaBench",
    "audiobench": "AudioBench",
    "babilong": "BABILong",
    "belebele": "Belebele",
    "bfcl": "Berkeley Function-Calling Leaderboard (BFCL v1-v4)",
    "bigcodebench": "BigCodeBench",
    "bird-sql": "BIRD-SQL",
    "casehold": "CaseHOLD",
    "classic-rl-suites": "Classic RL suites (Atari/ALE, Procgen, NetHack LE, MineRL/MineDojo, Crafter, GVGAI, DMLab-30, Habitat, BabyAI, TextWorld, Jericho, ScienceWorld)",
    "clutrr": "CLUTRR",
    "crmarena-pro": "CRMArena / CRMArena-Pro",
    ...
    "factscore": "FActScore",
    "financebench": "FinanceBench (+ DocFinQA)",
    "finben": "FinBen",
    "followbench": "FollowBench",
    "gama-bench": "GAMA-Bench",
    "gamebench": "GameBench",
    "gamebot": "GAMEBoT",
    "gamedevbench": "GameDevBench",
    "genai-bench": "GenAI-Bench",
    "halueval": "HaluEval / HaluEval 2.0",
    "harmbench": "HarmBench",
    ...
    "ifbench": "IFBench",
    "ifeval": "IFEval",
    "indicgenbench": "IndicGenBench / IndicMMLU",
    "infinitebench": "InfiniteBench",
    "jailbreakbench": "JailbreakBench",
    "kaggle-game-arena": "Kaggle Game Arena",
    "kaggle-game-arena-elo": "Kaggle Game Arena (Chess Elo)",
    "legalbench": "LegalBench (via Vals AI)",
    "llm-hanabi": "LLM-Hanabi",
    "lmgame-bench": "lmgame-Bench",
    "longbench-v2": "LongBench / LongBench v2",
    "mask": "MASK",
    "mcp-atlas": "MCP-Atlas",
    "medmcqa": "MedMCQA",
    "medqa": "MedQA / MedQA-USMLE",
    "medxpertqa": "MedXpertQA",
    "mgsm": "MGSM (Multilingual GSM8K)",
    "mind2web": "Mind2Web",
    "miniwob-plus-plus": "MiniWoB++",
    "mint-bench": "MINT-Bench",
    "mme": "MME (Multimodal LLM Evaluation)",
    "mmlu-prox": "MMLU-ProX",
    "mrcr-v2": "MRCR v2 (Multi-Round Context Retrieval)",
    "mt-bench": "MT-Bench",
    "mteb": "MTEB (Massive Text Embedding Benchmark)",
    "multiagentbench": "MultiAgentBench (MARBLE)",
    "multichallenge": "MultiChallenge",
    "musr": "MuSR (Multistep Soft Reasoning)",
    ...
    "roblox-open-game-eval": "Roblox Open Game Eval",
    "ruler": "RULER",
    ...
    "tau2-bench-telecom": "tau2-bench (Telecom)",
    "tombench": "ToMBench",
    "toolbench": "ToolBench / ToolEval",
    "vectara-hallucination-leaderboard": "Vectara Hallucination Leaderboard",
    "videogamebench": "VideoGameBench",
    "visualwebarena": "VisualWebArena",
    "webbench": "WebBench",
    "webvoyager": "WebVoyager",
    "werewolf-arena": "Werewolf Arena",
    "wildbench": "WildBench",
    "windows-agent-arena": "Windows Agent Arena",
    "wmdp": "WMDP (Weapons of Mass Destruction Proxy)",
    "workarena": "WorkArena / WorkArena++",
