...
* [Model Progress, Limitations and Forecasts](#model-progress-limitations-and-forecasts)
    * [Theoretical Source of Performance Gains](#theoretical-source-of-performance-gains)
        * [1. Pre-training](#1-pre-training)
            * [Kaplan 2020](#kaplan-2020)
            * [Chinchilla 2022](#chinchilla-2022)
            * [Entropy Floor - Some Information theory](#entropy-floor---some-information-theory)
        * [2. Inference-time/Chain of Thought Scaling](#2-inference-timechain-of-thought-scaling)
        * [3. Post-Training/Reinforcement Learning with Human Feedback (RLHF) Scaling](#3-post-trainingreinforcement-learning-with-human-feedback-rlhf-scaling)
        * [4. Engineering and Other Scaling opportunities](#4-engineering-and-other-scaling-opportunities)
    * [Source and Forecasts of Current Performance Gains](#source-and-forecasts-of-current-performance-gains)
        ...
        * [Other Current Limitations](#other-current-limitations)
            ...
            * [Expert Critiques](#expert-critiques)
            * [Current Phenomenology - Limtations](#current-phenomenology---limtations)
...
* [(Maybe) Possible Future](#maybe-possible-future)
    ...
    * [How Close are we to Drop-in Replacements of different roles?](#how-close-are-we-to-drop-in-replacements-of-different-roles)
        ...
        * [verifiability](#verifiability)
            * [What jobs are most at risk?](#what-jobs-are-most-at-risk)
    * [The Future (maybe) - Long-term](#the-future-maybe---long-term)
        * [ASI?](#asi)
* [Summary](#summary)
    * [What kinds of discoveries are needed for the next level](#what-kinds-of-discoveries-are-needed-for-the-next-level)
